...
FeaturePlot(object = dataset, features = "nFeatures",reduction = "pca")
...
highest_genes <- sort(PC_df[,paste0('PC_', nPC)], decreasing = TRUE)[1:5]
lowest_genes <- sort(PC_df[,paste0('PC_', nPC)], decreasing = FALSE)[1:5]
highest_genes
lowest_genes
```
...
```{r}
#ggo1 = CallGroupGo(list_topVarPC1)
#ggo2 = CallGroupGo(list_topVarPC2)
#ggo3 = CallGroupGo(list_topVarPC3)

ego1 = CallEnrichGo(list_topVarPC1,0.01,0.05)
...
```{r}
#barplot(ggo2, drop=TRUE, showCategory=10,main = "Genes associated with PC2")
barplot(ego2, showCategory=25, main ="enrich genes PC2")
barplot(ego2p, showCategory=25, main ="enrich genes PC2")
barplot(ego2m, showCategory=25, main ="enrich genes PC2")
```

```{r}
#barplot(ggo3, drop=TRUE, showCategory=10,main = "Genes associated with PC3")
barplot(ego3, showCategory=25, main ="enrich genes PC3")
barplot(ego3p, showCategory=25, main ="enrich genes PC3")
barplot(ego3m, showCategory=25, main ="enrich genes PC3")
```
