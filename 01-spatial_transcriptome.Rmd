...
We will be using one of the dataset publilshied with {Nitizan2019} et al. The data are alreay filtered ("high quality cells") and log-normalized. 
...
* {#Karaiskos2017} et al.The Drosophila embryo at single-cell transcriptome resolution. Science13 Oct 2017 : 194-199 
* {#Nitzan2019} et al. Gene expression cartography. Nature.2019 Dec;576(7785):132-137.  
...
* {#Nitizan2019} and al. advised to use the **normalized gene expression matrix** (e.g. using the global scaling log-normalization method)
